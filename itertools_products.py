...
from itertools import product   # importing itertolls product

a=list(map(int, input().split()))  #taking input list a
b=list(map(int, input().split()))      #taking input list b
print(*product(a,b))  #applying product operation on a and b 

#to know about itertools.product() see below:
